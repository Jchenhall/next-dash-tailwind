...
export const Nav = () => {
  return (
    <div className=" navbar justify-between sticky top-0 z-20 w-20 h-screen bg-slate-400/20  backdrop-blur-lg drop-shadow-lg flex-col">
      ...
      <div className="divider-vertical bg-orange-300/40 w-1 rounded-2xl h-1/2"></div>
      <div>
        <ul className="menu  ">
          <li className="p-2">
      ...
      <div className="divider-vertical  bg-orange-300/40 w-1 rounded-full h-1/2"></div>
      <div className="py-16 flex-row text-md w-fit -rotate-90 text-center whitespace-nowrap ">
        <CgCopyright size={20} />
        <h1 className="mx-1">
          <span className="text-orange-500 text-lg">X</span>-holidays
        </h1>
      </div>
    </div>
  );
